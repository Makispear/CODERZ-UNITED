        ...
        <div div className="background-blur fixed w-screen h-screen z-50 top-0 remove">
            ...
            <div data-tip="welcome" className="text-white single-tip p-2 grid place-content-center text-center primary-radius shadow-md shadow-gray-800">
                ...
                <h2 className="font-bold">
                    Hi {props.getCompletedLessons.firstName}, Welcome!
                </h2>
                <h3>
                ...
                <p className="mt-10 text-black">
                    Here are 3 tips to help you navigate the lessons
                </p>
            ...
            {/* LESSON NUMBER */}
            <div data-tip="lessonNumber" className="none w-full text-white single-tip p-2 grid place-content-center text-center primary-radius shadow-md shadow-black justify-baseline">
                <div className="w-full flex justify-end">
                    <button className="flex justify-end bg-white text-black primary-radius px-3" onClick={removeTip}>
                        Close
                    </button>
            ...
            {/* Bread Crumbs */}
            <div data-tip="breadcrumb" className="none w-full text-white single-tip p-2 grid place-content-center text-center primary-radius shadow-md shadow-black justify-baseline">
                <div className="w-full flex justify-end">
                    <button className="flex justify-end bg-white text-black primary-radius px-3" onClick={removeTip}>
                        Close
                    </button>
            ...
            {/* Explainer  */}
            <div data-tip="explainer" className="none w-full text-white single-tip p-2 grid place-content-center text-center primary-radius shadow-md shadow-black justify-baseline">
                <div className="w-full flex justify-end">
                    <button className="flex justify-end bg-white text-black primary-radius px-3" onClick={removeTip}>
                        Close
                    </button>
                ...
                <div className="w-auto flex justify-between gap-3 mt-10">
                    ...
                    <button className="lessonNumberNextButton mb-5 mx-5 px-3 bg-transparent border-2 border-white hover:bg-white hover:text-tertiary primary-radius cursor-pointer" onClick={removeTip}>
                        Finish
                    </button>

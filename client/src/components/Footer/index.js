...
export default function Footer() {
  return (
    <footer className="w-full flex flex-col bg-tertiary border-t-2 border-t-white">
      <div className="w-full flex flex-wrap justify-between gap-5 p-10 sm:p-28 pb-5">
        {/* left side  */}
        <div className="flex flex-col">
          {/* social media  */}
          <div className="font-bold">
            <h2 className="text-white text-4xl">FOLLOW US ON SOCIAL MEDIA</h2>
        ...
        {/* right side  */}
        <div className="font-bold">
          <h2 className="text-white text-4xl">SIGNUP FOR OUR WEEKLY NEWSLETTER</h2>
